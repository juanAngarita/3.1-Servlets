...
public class CookieServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cookie nombreUsuario = new Cookie("nombreUsuario", "Juan");
        ...
        if(cookies != null){
            ...
            if(c.getName().equals("visitas")){
                int anterior = Integer.parseInt(c.getValue());
                anterior++;
                c.setValue(Integer.toString(anterior));
                encontrado = true;
        ...
        if(!encontrado){
                Cookie cantidadVisitas = new Cookie("visitas","0");
        response.addCookie(cantidadVisitas);
        }
